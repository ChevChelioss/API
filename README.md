...
#### Данный проект представляет собой автоматизированный тест-кейс для тестирования API сервиса [Reqres](https://reqres.in/). В проекте используется библиотека Requests для отправки HTTP-запросов и получения ответов, а также библиотеки Allure и Logging для логирования процесса тестирования.
